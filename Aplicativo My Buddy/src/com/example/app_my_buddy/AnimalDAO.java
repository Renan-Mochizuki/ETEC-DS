...
public class AnimalDAO extends SQLiteOpenHelper{
		...
		public void onCreate(SQLiteDatabase db) {
			...
			String inse1 = "insert into animal(classe, nome, sexo, necessidade, descricao, imagem) values ('cachorro','Boris','Macho','Dificuldade para enxergar','Extremamente animado e adora estar com outros','R.drawable.boris')";
			db.execSQL(inse1);
			String inse2 = "insert into animal(classe, nome, sexo, necessidade, descricao, imagem) values ('gato','Aladin','Macho','','Bem dorminhoco','R.drawable.aladin')";
			db.execSQL(inse2);
		}

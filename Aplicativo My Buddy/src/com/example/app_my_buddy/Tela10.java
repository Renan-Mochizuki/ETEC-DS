...
public class Tela10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		radioatencao.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					@Override
		...
		radioclasse.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					@Override
					public void onCheckedChanged(RadioGroup arg0, int arg1) {
		...
		cadastrar.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (cnome.equals("") || classe == null || sexo == null || cdesc.equals("")) {
					Toast.makeText(Tela10.this, "Complete todos os campos", Toast.LENGTH_SHORT).show();
				} else if (caminho.equals("") || caminho == null){
					Toast.makeText(Tela10.this, "Insira uma imagem", Toast.LENGTH_SHORT).show();
					...
					a.setDescricao(cdesc);
					a.setClasse(classe);
					a.setImagem(caminho);
					db = new AnimalDAO(Tela10.this);
					db.salvar_animais(a);

					Toast.makeText(Tela10.this, "Cadastrado",Toast.LENGTH_SHORT).show();
				}
			}
		});
		...
		alterar.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				String cdesc = desc.getText().toString();
				String cnome = nome.getText().toString();
				String cid = idtxt.getText().toString();
				if (cnome.equals("") || classe == null || sexo == null || cdesc.equals("")) {
					Toast.makeText(Tela10.this, "Complete todos os campos", Toast.LENGTH_SHORT).show();
				} else if (r0.isChecked() && necessidade.getText().toString().equals("")) {
					Toast.makeText(Tela10.this, "Complete todos os campos", Toast.LENGTH_SHORT).show();
				} else if (cid.equals("") || cid.equals("0")){
					Toast.makeText(Tela10.this, "Insira um código válido", Toast.LENGTH_SHORT).show();
				} else {
					Animais a = new Animais();
					a.setId(Integer.parseInt(cid));
